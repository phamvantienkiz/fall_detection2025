...
def read_data(file_path):
    ...
    return data.values  # Ma trận 90x3 (X, Y, Z)
...
np.save(os.path.join(OUTPUT_DIR, "dataset_3400_ws90_s10.npy"), dataset)
np.save(os.path.join(OUTPUT_DIR, "labels_3400_ws90_s10.npy"), labels)
