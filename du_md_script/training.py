...
from bi_model import build_model
...
def train_model(data_dir, seq_length=90, num_classes=num_classes, epochs=50, batch_size=32):
    ...
    checkpoint = ModelCheckpoint(
        filepath=os.path.join(model_dir, "best_model_bi_v3v7.h5"),
    ...
    final_model_path = os.path.join(model_dir, "final_model_bi_v3v7.h5")
    ...
    plt.savefig(os.path.join(save_result, "history_model_bi_v3v7.png"))
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_result, "cm_model_bi_v3v7.png"))
    plt.show()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(os.path.join(save_result, "roc_model_bi_v3v7.png"))
    plt.show()
