...
from umafall_bi_model import build_model, build_model_cnn, build_model_bilstm, build_model_lstm
...
def train_model(data_dir, seq_length=90, num_classes=num_classes, epochs=20, batch_size=32):
    ...
    checkpoint = ModelCheckpoint(
        filepath=os.path.join(model_dir, "best_model_bilstm_bi_umaf_v1v1.h5"),
    ...
    final_model_path = os.path.join(model_dir, "final_model_bilstm_bi_umaf_v1v1.h5")
    ...
    plt.savefig(os.path.join(save_result, "history_model_bilstm_bi_umaf_v1v1.png"))
    plt.show()
    ...
    plt.tight_layout()
    save_result = "../umafall_models/results"
    plt.savefig(os.path.join(save_result, "cm_model_bilstm_bi_umaf_v1v1.png"))
    plt.show()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(os.path.join(save_result, "roc_model_bilstm_bi_umaf_v1v1.png"))
    plt.show()
